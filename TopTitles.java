...
public class TopTitles extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Path tmpPath = new Path("/mp2/tmp");    //this can be any path that you can speficy here.
    ...
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while(st.hasMoreTokens()) {
                ...
                if(!this.stopWords.contains(currentToken.trim().toLowerCase())) {
                    context.write(new Text(currentToken.trim().toLowerCase()), new IntWritable(1));
                }
            }
        }
    }
    ...
    public static class TopTitlesMap extends Mapper<Text, Text, NullWritable, TextArrayWritable> {
        Integer N;
        private TreeSet<Pair<Integer, String>> sortedWordCount = new TreeSet<Pair<Integer, String>>();
